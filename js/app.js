...
function render(){
  ...
  const header=div({background:cl.surface,borderBottom:"1px solid "+cl.border,padding:"0 20px",display:"flex",alignItems:"center",justifyContent:"space-between",height:"54px",position:"sticky",top:"0",zIndex:"100"},[
    div({display:"flex",alignItems:"center",gap:"10px"},[
      (function(){var logo=el("div",{style:{width:"32px",height:"32px",borderRadius:"7px",background:"linear-gradient(135deg,"+cl.gold+","+cl.goldDim+")",display:"flex",alignItems:"flex-end",justifyContent:"center",flexShrink:"0",position:"relative",overflow:"hidden",padding:"0 2px 3px"}});logo.innerHTML='<svg viewBox="0 0 32 28" width="28" height="24" style="display:block"><text x="1" y="24" font-family="Space Grotesk,monospace" font-size="9" font-weight="900" fill="#fff">d</text><g transform="translate(16,2)"><line x1="0" y1="0" x2="0" y2="6" stroke="#fff" stroke-width="1.2" stroke-linecap="round"/><polygon points="-1.5,6 1.5,6 0,3" fill="#fff"/><rect x="-2" y="6" width="4" height="3" fill="#fff" rx="0.3"/><polygon points="-3.5,9 3.5,9 2,6 -2,6" fill="#fff"/><rect x="-4" y="9" width="8" height="3" fill="#fff" rx="0.3"/><polygon points="-5.5,12 5.5,12 4,9 -4,9" fill="#fff"/><rect x="-6" y="12" width="12" height="4" fill="#fff" rx="0.5"/><rect x="-7" y="16" width="14" height="2" fill="#fff" rx="0.3"/><rect x="-1" y="18" width="2" height="4" fill="rgba(255,255,255,0.5)" rx="0.3"/><text x="-4.5" y="22" font-family="Space Grotesk,monospace" font-size="5.5" font-weight="900" fill="rgba(255,255,255,0.7)" letter-spacing="0.5">AI</text></g><text x="24" y="24" font-family="Space Grotesk,monospace" font-size="9" font-weight="900" fill="#fff">v</text></svg>';return logo;})(),
