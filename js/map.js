  ...
  setTimeout(function(){
    ...
    if(_dvMapState.metric==="location"){
      ...
      METRO_STATIONS.forEach(function(s){
        ...
        m.bindPopup('<div style="font-family:Space Grotesk,monospace;color:#E8EDF5;background:#0D1220;border-radius:6px;padding:8px 10px;border:1px solid #1C2540;font-size:11px;"><span style="color:#818CF8;">M</span> <b>'+s.n+'</b><br><span style="color:#6B7A9E;">'+s.line+' Line</span></div>',{className:"dv-popup",closeButton:false});
        m.addTo(map);
      });
      TRAM_STATIONS.forEach(function(s){
        ...
        m.bindPopup('<div style="font-family:Space Grotesk,monospace;color:#E8EDF5;background:#0D1220;border-radius:6px;padding:8px 10px;border:1px solid #1C2540;font-size:11px;"><span style="color:#D4A843;">T</span> <b>'+s.n+'</b><br><span style="color:#6B7A9E;">Dubai Tram</span></div>',{className:"dv-popup",closeButton:false});
        m.addTo(map);
      });
    }
