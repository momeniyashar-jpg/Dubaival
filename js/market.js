...
function renderAnalyzerResult(wrap){
  ...
  */
  ...
  var liText="Just valued a property in "+f.area+" using DubAIVal AI — "+val.verdict+" at AED "+val.fairPrice.toLocaleString()+". The platform tracks 11,500+ properties across 347 areas. #DubaiRealEstate #PropTech";
