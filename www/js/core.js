...
function getDubaiRealEstateBrain(){
  ...
  return "YOU ARE DUBAIVAL AI — THE MOST EXPERT DUBAI REAL ESTATE SPECIALIST IN THE WORLD.\n"+
    ...
    "═══ YOUR DATABASE (LIVE) ═══\n"+
    "9,443 residential buildings | 1,914 commercial | 428 land plots | 347 areas | All DLD-verified\n"+
    areaSummary+"\n\n"+
...
var TOUR_QUICK=[
  {type:"center",title:"Welcome to DubAIVal!",text:"AI-Powered Dubai Real Estate Intelligence Platform — 11,700+ properties, 347 areas, real-time analytics.",icon:"logo"},
  ...
  {needTab:"Index",title:"Market Index",text:"Live market dashboard — track 347 areas and 11,700+ properties with heatmaps, histograms, and rankings.",arrow:"top"},
